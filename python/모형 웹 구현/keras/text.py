...
def review_predict(new_sentence):
    model = load_model('C:/machine_learning/python/17. 텍스트 마이닝/RNN_model.h5')
    # model = load_model('C:/machine_learning/python/17. 텍스트 마이닝/CNN_model.h5')
    tokenizer = joblib.load('C:/machine_learning/python/17. 텍스트 마이닝/tokenizer.h5')
    okt = Okt()
    new_sentence = okt.morphs(new_sentence, stem=True) # 토큰화
    stopwords = ['의', '가', '이', '은', '들', '는', '좀',
                 '잘', '걍', '과', '도', '를', '으로', '자', '에', '와', '한',
                 '하다']
